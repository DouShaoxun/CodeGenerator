...
import static cn.dsx.codegenerator.utils.ConstantUtil.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/hr";
    ...
    public static void main(String[] args) {
         ...
         */
           //genCodeByCustomModelName("hr","Hr");

        /**
         * genCodeNoServiceNoController("输入表名","输入自定义Model名称");
         * 同时生成mapper,dao,pojo
         */
        genCodeNoServiceNoController("emp_daily", "EmpDaily");
    }
